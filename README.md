...
Log Sources: Sysmon (Event IDs 1, 11, 12, 13, etc, Heartbeat, WindowsEvent
Languages: Kusto Query Language (KQL), JavaScript Object Notation(JSON)
Automation: Data Collection Rules (DCR), Analytics Rules
...
Focus: Identity security and high-volume authentication failures.
Tools: Hydra (Kali Linux).

Module 02: Persistence-Workbook-Lab/ Persistence & Monitoring

Focus: Registry/Task persistence and real-time health dashboards.
Feature: Custom Sentinel Workbook with conditional formatting.
